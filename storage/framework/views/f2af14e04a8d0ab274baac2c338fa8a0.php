                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="phone_no" type="text" class="form-control"
                                                id="phone_no" value="<?php echo e(auth()->user()->phone_no ?? ''); ?>">
                                        </div>
                                    </div>
...
<?php /**PATH G:\laragon\www\e-pushti-laravel\resources\views/frontend/student/student-profile.blade.php ENDPATH**/ ?>