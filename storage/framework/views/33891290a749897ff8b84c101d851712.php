...
@media screen and (max-width: 768px) {
    ...
    <div class="container certificate-container" style='text-align: center;'>
        <div class="certificate">
            <img src="<?php echo e(public_path('images/Certificate/certificate-border.png')); ?>" class="certifiate-border"
                alt="Certificate Border">

            <img src="<?php echo e(public_path('images/Certificate/BIID-logo.png')); ?>" class="BIID-logo" alt="" style="position: absolute;">

            <div class="certificate-content" style="margin: 1rem;">
                <img src="<?php echo e(public_path('assets/img/Screenshot_9_1.png')); ?>" class="e-pushti-logo" style="width: 16%;" alt="">
                <h1 style="padding: 1rem 0;">Certificate of Appreciation</h1>
                <h3 class="username" style="padding:1rem 0;"><?php echo e(auth()->user()->name ?? 'Your Name'); ?></h3>
...
<?php /**PATH G:\laragon\www\temp_129\resources\views/frontend/pdf/student-pdf-certificate.blade.php ENDPATH**/ ?>