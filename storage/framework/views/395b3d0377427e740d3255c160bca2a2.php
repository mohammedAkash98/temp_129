               ...
               <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 text-center d-flex justify-content-center fadeInUp">
                <a href="<?php echo e(route('courses')); ?>">
                    <div class="card" style="width: 18rem;">
                        <img src="<?php echo e(asset('storage/chapter/'. $chapter->image)); ?>"
                        class="card-img-top" alt="<?php echo e($chapter->name ?? ''); ?>">
                        <div class="card-body">
                            <h5 class="card-title"><?php echo e($numto->bnNum(1+$key)); ?>: খাদ্য ও পুষ্টি বিষয়ক তথ্য</h5>
                            <a href="<?php echo e(route('courses')); ?>" class="btn btn-bg text-dark">বিস্তারিত</a>
                        </div>
                    </div>
                </a>
            </div>
...
<?php /**PATH C:\xampp\htdocs\epushtiN\temp_129\resources\views/home_page/home_page.blade.php ENDPATH**/ ?>