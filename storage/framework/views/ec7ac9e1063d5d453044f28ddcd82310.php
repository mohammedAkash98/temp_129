...
<div class="pagetitle">
  ...
  <div class="container">
    <h2>Add Webinar</h2>
    <form action="<?php echo e(route('webinar.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="row g-4">
            <div class="col-md-12">
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\laragon\www\temp_129\resources\views/backend/webinar/webinar-create.blade.php ENDPATH**/ ?>