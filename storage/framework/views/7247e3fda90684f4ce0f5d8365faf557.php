...
<div class="pagetitle">
  ...
  <?php elseif($lessons->count() == 0): ?>
  <div class="container mt-5 text-center">
      <h4>There is no lessons added yet.</h4>
      <a href="<?php echo e(route('lesson.create')); ?>" class="btn btn-primary btn-sm mb-3 text-white"><i class="fa-solid fa-plus"></i>
          Add Lesson</a>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\laragon\www\e-pushti-laravel\resources\views/backend/quiz/quiz-create.blade.php ENDPATH**/ ?>