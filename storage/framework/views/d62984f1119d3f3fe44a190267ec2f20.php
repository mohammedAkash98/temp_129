  ...
  <div class="container mt-5">
    ...
    <form action="<?php echo e(route('lesson.update',$lesson->id)); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="lessonDescription" name="description" rows="4"><?php echo e($lesson->description); ?></textarea>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\laragon\www\e-pushti-laravel\resources\views/backend/lesson/lesson-edit.blade.php ENDPATH**/ ?>